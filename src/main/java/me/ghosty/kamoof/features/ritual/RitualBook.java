...
public final class RitualBook {
	...
	private static List<BaseComponent[]> getPages() {
		List<String> pages = Placeholder.apply(Arrays.asList(
			"<dark_red>Pacte Ensanglanté<br><br><red>Ce pacte te permet d'augmenter ta vie de <dark_red>5 <red>coeurs t'es proposé, mais ta prochaine mort te coûtera 3 têtes...<br><dark_red><bold>Vas-tu l'accepter ?<br><br><click:run_command:%command1%><red><bold>[Accepter le Pacte]",
